...
const INITIAL_HOURS: HourRow[] = [
  { day: "Monday", key: "mon", open: "08:00", close: "17:00", closed: false },
  { day: "Tuesday", key: "tue", open: "08:00", close: "17:00", closed: false },
  { day: "Wednesday", key: "wed", open: "08:00", close: "17:00", closed: false },
  { day: "Thursday", key: "thu", open: "08:00", close: "17:00", closed: false },
  { day: "Friday", key: "fri", open: "08:00", close: "17:00", closed: false },
  { day: "Saturday", key: "sat", open: "08:00", close: "17:00", closed: false },
  { day: "Sunday", key: "sun", open: "", close: "", closed: true },
];

const INITIAL_SERVICES: ServicePrice[] = [
  { id: "small_exterior", name: "Small — Exterior Only", price: 35, duration: "30 min" },
  { id: "small_full", name: "Small — Interior + Exterior", price: 55, duration: "45 min" },
  { id: "medium_exterior", name: "Medium — Exterior Only", price: 40, duration: "35 min" },
  { id: "medium_full", name: "Medium — Interior + Exterior", price: 65, duration: "50 min" },
  { id: "large_exterior", name: "Large — Exterior Only", price: 45, duration: "40 min" },
  { id: "large_full", name: "Large — Interior + Exterior", price: 75, duration: "60 min" },
...
const INITIAL_TIERS: MembershipTier[] = [
  {
    id: "weekly_small_ext",
    name: "Weekly — Small Exterior",
    price: 120,
    washesPerMonth: "4",
    vehicles: 1,
    perks: "Priority booking, 10th wash free",
  },
  {
    id: "weekly_small_full",
    name: "Weekly — Small Full",
    price: 180,
    washesPerMonth: "4",
    vehicles: 1,
    perks: "Priority booking, 10th wash free",
